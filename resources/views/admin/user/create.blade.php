                        ...
                        <ul id="sale" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                            <li class="">
                                <a href="{{url('admin/report/daily')}}">
                                    <i class="las la-minus"></i><span>Daily Sale Report</span>
                                </a>
                            </li>
                            <li class="">
                                <a href="{{url('admin/report/monthly')}}">
                                    <i class="las la-minus"></i><span>Monthly Sale Report</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="username" class="form-control  @error('name') is-invalid @enderror" placeholder="Enter Username"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="is_admin" class="selectpicker form-control"
                                                ...
                                                <option value="2" {{ old('is_admin') == '3' ? 'selected' : '' }}>Manager
                                                </option>
                                                <option value="3" {{ old('is_admin') == '2' ? 'selected' : '' }}>Store Keeper
                                                </option>
                                                <option value="4" {{ old('is_admin') == '3' ? 'selected' : '' }}>Staff
                                                </option>
                                            </select>
                                        </div>
                                    </div>
