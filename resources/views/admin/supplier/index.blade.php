               ...
               <div class="row">
                   <div class="col-lg-12">
                       <div class="card-header d-flex flex-wrap flex-wrap align-items-center justify-content-between mb-4">
                           ...
                           <a href="{{url('admin/supplier/create')}}" class="btn btn-primary add-list"><i class="fa fa-plus mr-3"></i>Add Supplier</a>
                       </div>
                   </div>
                   <br>
                   <div class="card-body">
                           ...
                           <tbody class="ligth-body">
                            @foreach ($suppliers as $key => $supplier)
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('/public/storage/supplier/'.$supplier->supplier_img) }}"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            src="{{ asset('/public/storage/supplier/'.$supplier->supplier_img) }}"
                                                            alt="">
