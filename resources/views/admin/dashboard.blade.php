                        ...
                        <ul id="product" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                            ...
                            <li class="">
                                <a href="{{url('admin/product/manage-product')}}">
                                    <i class="fa fa-minus"></i><span>Remainig Product</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                                            ...
                                            <div class="card m-0">
                                                <div class="card-body">
                                                    <div class="bg-warning-light rounded">
                                                        <img src="{{ asset('/public/storage/stock/' . $data->stock_img) }}" class="style-img img-fluid m-auto p-3 m-0" alt="image">
                                                    </div>
                                        ...
                                        <li class="col-lg-3 m-0">
                                            <div class="card m-0">
                                                <div class="card-body">
                                                    ...
                                                    <div class="style-text text-left mt-3">
                                                        <h6 class="mb-1">{{$data->product_name}}</h6>
