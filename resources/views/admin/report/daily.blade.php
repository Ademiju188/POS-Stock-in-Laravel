                            ...
                            <div class="col-md-4 text-center">
                                ...
                                <div class="header-title">
                                    <h4 class="card-title">Total Amount:
                                        <span class="text-secondary"> # {{number_format($daily->sum('unitprice')), 2}} </span>
                                    </h4>
                                </div>
                                </div>
                            </div>
                            <div class="col-md-4 text-center">
                                <form action="{{url('/admin/report/previous')}}" method="POST">
                                    {{ csrf_field() }}
                                    <input type="date" class="form-control-sm" name="filter" value="">
                                    ...
                                    <table class="data-table table mb-0 tbl-server-info table-bordered text-center">
                                        ...
                                        @foreach ($daily as $key => $data)
                                            <tr>
                                                ...
                                                <td>{{$data->qty}}</td>
                                                <td>{{number_format($data->unitprice), 2}}</td>
                                                <td>
                                                    <div class="badge-card badge-success btn-sm">SUCCESS</div>
                                                </td>
                                            </tr>
