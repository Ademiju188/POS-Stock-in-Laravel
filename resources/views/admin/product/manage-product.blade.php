                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <div class="header-title">
                                <h4 class="card-title">Out of Product</h4>
                            </div>
                            <a href="{{url('admin/product/create')}}" class="btn btn-primary add-list"><i
                                ...
                                <table id="example2" class="data-table table table-striped table-bordered mb-0 tbl-server-info">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-sm badge-danger">{{$data->quantity}}</button>
                                            </td>
                                        </tr>
                                        @endif
                                        @endforeach
